...
public class rangeMinUpdateVideo {
    int[][] seg;

    // first elem is segment tree and second is lazy seg tree
    public rangeMinUpdateVideo(int n) {
        seg = new int[4 * n][2];
    }
    ...
    public void build(int index, int low, int high, int[] arr) {
        ...
        seg[index][0] = Math.min(seg[2 * index + 1][0], seg[2 * index + 2][0]);
    }
    ...
    public static void main(String[] args) {
        ...
        rangeMinUpdateVideo segTree = new rangeMinUpdateVideo(n);
